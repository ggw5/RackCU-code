...
#define max_updt_strps        1 //it defines the maximum stripes to be updated before invoking delta commit

/*log table*/
#define max_log_chunk_cnt     10000
...
#define cau_num_rplc          0

#define stripe_num            30000
